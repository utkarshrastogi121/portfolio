...
const CTAButton = memo(({ href, text, icon: Icon }) => (
  <a href={href}>
    <button className="group relative w-[160px]">
      <div className="absolute -inset-0.5 bg-gradient-to-r from-[#4f52c9] to-[#8644c5] rounded-xl opacity-50 blur-md group-hover:opacity-90 transition-all duration-700 lg:mx-20"></div>
...
const SOCIAL_LINKS = [
  ...
  { icon: Instagram, link: "https://www.instagram.com/utkarsh_rastogi.121" },
];
